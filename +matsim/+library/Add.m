classdef Add < matsim.library.block
%Add Creates a simulink Add block.
% Syntax:
%   blk = Add(INPUTS);
...
%   See also BLOCK.
    ...
    methods
        function this = Add(varargin)
            ...
            this = this@matsim.library.block('BlockName','Add','parent',parent,args{:});

            if matsim.helpers.isArgSpecified(p,'inputs')
                this.set('Inputs',repmat('+',1,max(1,length(inputs))))
